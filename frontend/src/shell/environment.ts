...
export const environments: Environment[] = [
  {
    ...
    name: 'Development',
    key: 'dev',
    blurb: 'Local and CI work. Nothing reaches anyone.',
  ...
  },
  {
    ...
    name: 'Staging',
    key: 'stg',
    blurb: 'Production-shaped data. The last check before release.',
  ...
  },
  {
    ...
    name: 'Production',
    key: 'prod',
    blurb: 'Real people. Changes land the moment you make them.',
