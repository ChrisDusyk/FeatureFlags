...
/// <summary>
/// Loads <c>shared/evaluation/conformance/*.json</c>. A near-copy of the loader in
/// <c>FeatureFlags.Domain.Tests</c>, and deliberately so: sharing it would mean this suite and that
/// one could only ever fail together, when the whole point of running the vectors twice is that
/// these are different compilations of the same source.
///
/// <para>
