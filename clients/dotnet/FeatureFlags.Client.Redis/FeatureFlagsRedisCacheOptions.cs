...
/// <summary>
/// How the Redis cache tier behaves, on top of whatever <see cref="Client.FeatureFlagsOptions"/>
/// already says about reaching the FeatureFlags server.
/// </summary>
public sealed class FeatureFlagsRedisCacheOptions
{
    /// <summary>
    ...
    /// once the FeatureFlags server cannot be reached at all. This is the number that actually
    ...
    /// <summary>
    /// The fraction of <see cref="Client.FeatureFlagsOptions.PollingInterval"/> after which a read
